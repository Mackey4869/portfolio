...
const experienceLinksJa = [
  { label: "企業サイト", href: "https://nititech.jp/" },
  { label: "製品ページ", href: "https://nititech.jp/lp/brest-ai-academy/" },
  { label: "プレスリリース", href: "https://prtimes.jp/main/html/rd/p/000000015.000151759.html" },
]
const experienceLinksEn = [
  { label: "Company", href: "https://nititech.jp/en/" },
...
export const portfolioContent: Record<Locale, PortfolioContent> = {
  ja: {
    ...
    experience: {
      kicker: "01", title: "Webサービスの開発と改善",
      intro: "株式会社NITI Technologyで、教育分野のWebサービス開発に携わっています。公式の公開情報と、公開可能な担当範囲のみを掲載しています。",
    ...
    research: {
      kicker: "02", title: "写真確認支援の研究", status: "研究中",
    ...
    projects: {
      kicker: "03", title: "課題解決とチーム開発", intro: "数を並べるのではなく、役割と工夫を説明できるプロジェクトを選んでいます。",
    ...
    skills: {
      kicker: "04", title: "スキル", intro: "自己評価の点数ではなく、どの環境で使ったかを基準に整理しています。",
      groups: [
    ...
    qualifications: { kicker: "05", title: "資格・学習", achieved: "取得済み", learning: "学習中", items: [
    ...
    leadership: { kicker: "06", title: "リーダーシップ・指導", intro: "開発以外でも、異なる立場の人と合意をつくり、分かりやすく伝える経験を重ねています。", items: [
    ...
    photography: { kicker: "07", title: "写真", intro: "写真は、技術とは別の角度から培ってきた観察力と表現の手段です。掲載写真は本人が撮影しています。", images: photosJa },
    contact: { kicker: "08", title: "連絡先", description: "制作物や開発の記録はGitHubで公開しています。お問い合わせはメールでも受け付けています。", githubLabel: "GitHub", githubHandle: "@Mackey4869", emailLabel: "メール", email: "tomytech626@gmail.com", note: "返信には数日いただく場合があります。" },
  ...
  en: {
    ...
    projects: { kicker: "03", title: "Problem Solving & Team Development", intro: "A focused selection where I can clearly explain the problem, my role, and the engineering decisions.", items: [{ title: "Gabaithon Spring 2025", category: "Hackathon / Team Development", description: "A hackathon project where a five-person team developed a web application.", facts: ["February 2025", "Five-person team", "Rapid development"], contribution: "I participated in the project as a team member, from planning through implementation and presentation.", technologies: ["Web Application", "Team Development"], result: "Special Prize", links: [{ label: "GitHub", href: "https://github.com/sgupge2545/gabaithon202502saga2" }] }] },
    skills: { kicker: "04", title: "Skills", intro: "Skills are organized by where I have used them, rather than by subjective percentages.", groups: [
    ...
    qualifications: { kicker: "05", title: "Qualifications & Learning", achieved: "Qualifications", learning: "Currently Learning", items: [{ title: "JDLA Deep Learning for GENERAL", detail: "Japan Deep Learning Association", type: "achieved" }, { title: "TOEIC L&R 760", detail: "Also used for technical information", type: "achieved" }, { title: "Applied Information Technology Engineer", detail: "Studying structured CS and IT knowledge", type: "learning" }, { title: "AtCoder Beginner Contest", detail: "Algorithms and data structures", type: "learning" }] },
    leadership: { kicker: "06", title: "Leadership & Teaching", intro: "Beyond engineering, I have learned to align different perspectives and explain technical ideas clearly.", items: [{ title: "Photography Club President", meta: "Around 100 members", description: "Led event planning, operations, member coordination, and communication with partner companies.", link: { label: "View club activities on Instagram", href: "https://www.instagram.com/sagauni_photo/" } }, { title: "Teaching Assistant", meta: "University", description: "Support exercises and student questions, adapting explanations to each learner." }] },
    photography: { kicker: "07", title: "Photography", intro: "Photography is another way I have developed observation and communication. Every photograph shown here is my own work.", images: photosEn },
    contact: { kicker: "08", title: "Contact", description: "My projects and development history are available on GitHub. You can also contact me by email.", githubLabel: "GitHub", githubHandle: "@Mackey4869", emailLabel: "Email", email: "tomytech626@gmail.com", note: "Please allow a few days for a reply." },
